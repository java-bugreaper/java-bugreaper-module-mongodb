...
public class MongoDb implements MongoDbInter, MongoDbAsserts, MongoDbConf {
    ...
    public MongoDb() {
        ...
        this.connectionString = YamlUtils.getStringValueByPath("modules.mongodb.url");
        String database = YamlUtils.getStringValueByPath("modules.mongodb.database");
    ...
    public void seeCollectionIsNotEmpty(String collectionName) {
        ...
        try {
            ...
            fail(
                    MessageFormat.format(
                            "Collection <{0}> expected to be not empty but has no records within {1}",
    ...
    private void assertRecordExists(String collectionName,
                                    String json,
                                    boolean strict) {
